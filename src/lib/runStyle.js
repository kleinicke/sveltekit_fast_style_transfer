...
export async function prepareAndRunStyle(
	...
	const inputTensor = new Tensor(new Float32Array(3 * imageSize * imageSize), 'float32', [
		1,
		3,
		imageSize,
		imageSize
	...
	const dataFromImageBack = ndarray(new Float32Array(imageSize * imageSize * 4), [
		imageSize,
		imageSize,
		4
	]);
	const dataProcessedBack = ndarray(new Float32Array(outputData), [1, 3, imageSize, imageSize]);
	// ops.assign(dataFromImageBack.pick(null, null, 3),255);//todo change!
	ops.assign(dataFromImageBack.pick(null, null, 0), dataProcessedBack.pick(0, 0, null, null));
	ops.assign(dataFromImageBack.pick(null, null, 1), dataProcessedBack.pick(0, 1, null, null));
	ops.assign(dataFromImageBack.pick(null, null, 2), dataProcessedBack.pick(0, 2, null, null));
	...
	console.log('result', outputMap, dataFromImageBack, dataProcessedBack, dataForImage);
